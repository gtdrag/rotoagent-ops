...
Last updated: April 4, 2026 at 8:01 AM CT (auto-generated)

## Current Metrics (Production DB)

| Metric | Value | Notes |
|--------|-------|-------|
| Registered Users | 46 | All have emails |
| Active Users (used AI) | 36 | Made at least one AI call |
| Paying Subscribers | 9 | 7 annual + 1 monthly |
| Free Users | 27 | |
| Conversion Rate | 25% | Paid / active |
| iOS Users (push enabled) | 18 | Only counts push-accepted users |
| Android Users (push enabled) | 8 | Only counts push-accepted users |
| Chrome Extension Installs | 3 | |
| New Signups (today) | 1 | |
| New Signups (7 day) | 8 | |
| New Signups (28 day) | 30 | |
